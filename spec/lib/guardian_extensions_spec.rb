  ...
  describe "#can_see_summary?" do
    ...
    context "when the user cannot generate a summary" do
      ...
      it "returns false" do
        ...
        expect(guardian.can_see_summary?(topic, AiSummary::COMPLETE)).to eq(false)
      end
      ...
      it "returns true if there is a cached summary" do
        ...
        expect(guardian.can_see_summary?(topic, AiSummary::COMPLETE)).to eq(true)
      end
    end
    ...
    context "when the topic is a PM" do
      ...
      it "returns false" do
        expect(guardian.can_see_summary?(pm, AiSummary::COMPLETE)).to eq(false)
      end
      ...
      it "returns true if user is in a group that is allowed summaries" do
        ...
        expect(guardian.can_see_summary?(pm, AiSummary::COMPLETE)).to eq(true)
      end
    end
